...
export default function About() {
  ...
  return (
    <section className='h-full md:pt-40 pt-10  text-white' id='about'>
            ...
            <div className=' h-full flex items-center px-10 pt-10 '>
              <div className='text-gray-500 my-3'>
                ...
                <button className='flex  justify-center items-center gap-3 bg-pink-600 px-7 py-3 text-white rounded-3xl hover:bg-gradient-to-r
                  ...
                  <a href="/portfolio/src/resume/resume (3).pdf" className='flex  items-center gap-3 ' download >Download <i class="fa-regular fa-file-lines text-xl"></i></a>
